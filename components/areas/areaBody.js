...
import PropertiesByAreas from "./propsByAreas";

export default function AreaBody(props) {
    return(
        <div className="flex content-wrap w-full mb-10 max-md:flex-wrap">
                ...
                <div className="basis-full md:basis-3/4 ml-5">
                    <h3>Description</h3>
                    <div className="mb-10">
                        <p>{props.area.areaDescription}</p>
                    </div>
                    <div className="mb-10">
                        <h3>Map</h3>
                    ...
                    <h3 className='font-medium'>All Properties at {props.area.areaName}</h3>
                    <div className='flex flex-wrap justify-between gap-y-10 mb-10'>
                        <PropertiesByAreas id={props.area._id} />
                    </div>
